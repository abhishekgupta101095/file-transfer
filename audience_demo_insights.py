...
# Date: 07-Mar-2024
# Description: Process and generate audience demographic insights view.
...
audience_demo_insights_table_name = config.audience_demo_insights_table_name
...
def process_data_view_for_attribute(attributename, tot_pop):
    ...
    if attributename == 'affinity':
        ...
        df_affinities = df_affinities[['sortcolumn', 'sortdata', 'record_count', 'rounded_percentage', 'rank', 'flag', 'tot_pop', 'data_load_metadata_id']]
        ...
        df = df[['sortcolumn', 'sortdata', 'record_count', 'rounded_percentage', 'rank', 'flag', 'tot_pop', 'data_load_metadata_id']]
        return df

def audience_demo_insights_view_process():
    df_3p_individual = Helper.select_table_data(individual_3p_table_name, cols=[], connection_string=connection_string)
    ...
    Helper.write_dataframe_to_postgresql_in_chunks(result, audience_demo_insights_table_name, chunksize=10000, connection_string=connection_string)

# if __name__ == '__main__':
#     audience_demo_insights_view_process()
