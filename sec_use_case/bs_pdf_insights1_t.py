...
data_fbl5n = data_fbl5n[['BP ','Customer','Net Due Date','Document Date', 'Document Type', 'Document Number','Payment Date', 'Arrears by net due date', 'Amount in Local Currency']]
...
df=pd.merge(data_fbl5n,data_knc, how='outer',on=['Business Partner','Business Partner'])
