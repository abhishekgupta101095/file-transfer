...
async def process_file(file_data: DBcls):
    print(file_data.file_name)
    return {"file_name": file_data.file_name, "user_query": file_data.query_param}

#Load data for UI
#data = pd.ExcelFile("C:/Users/a.a.madhu.karanath/SAP Finance2/Intelligent_coll_test2.xlsx")
data = pd.ExcelFile("C:/Users/abhishek.cw.gupta/Downloads/CollectionWorklistdata.xlsx")
...
with pdfplumber.open("C:/Users/abhishek.cw.gupta/Desktop/Amazon-2023-Annual Report.pdf") as f:
...
df_user_ex = pd.read_parquet("UserQueryExample_inc.parquet")
...
async def answer_question(db_details: DBcls, ans: bool = True):
    ...
    [
        ...
        },
        {
            ...
            "column_description": "Document number is a number of accounting document. It is unique per company code and fiscal year."
        },
        {
        ...
        }
        {
        ...
        }
         {
            ...
            "data_type": "int", 
            "sample_data": [25, 0], 
            "column_description": "If the overdue_invoice_sum value is between 5000 and 25000"
        }
         {
            "column_name": "Rule_3", 
            "data_type": "int", 
            "sample_data": [30, 0], 
            "column_description": "If the overdue_invoice_sum value is between 0 and 25000"
        }
         {
            "column_name": "Valuation points", 
            "data_type": "int", 
            "sample_data": [75, 40, 0], 
            "column_description": "The valuation points are the integer value which determines strategy it belongs to"
        }
        {
            "column_name": "Partner", 
            "data_type": "int", 
            "sample_data": ['104617', '104988'], 
            "column_description": "Unique number  to Identify a business partner in the SAP system."
        }    
        ]
    """
